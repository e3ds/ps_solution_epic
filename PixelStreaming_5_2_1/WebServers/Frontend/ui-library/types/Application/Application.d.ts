import { PixelStreaming, AggregatedStats, LatencyTestResults, InitialSettings, MessageStreamerList } from '@epicgames-ps/lib-pixelstreamingfrontend-ue5.2';
...
export declare class Application {
    ...
    handleStreamerListMessage(messageStreamingList: MessageStreamerList, autoSelectedStreamerId: string | null): void;
    /**
